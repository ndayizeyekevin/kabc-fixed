...
$breadcrumb_items = [
    ['name' => 'Reservations', 'link' => '../reservations/room_booking_list.php', 'active' => false],
    ['name' => 'Room Booking #' . $booking_id, 'link' => '', 'active' => true]
];
?>
                                            ...
                                            <div class="col-md-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            <div class="col-md-7">hhhDATES OF STAY</div>
