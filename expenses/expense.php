...
$breadcrumb_items = [
    ['name' => 'Expenses', 'link' => '../expenses/expense.php', 'active' => false],
    ['name' => 'Expenses', 'link' => '', 'active' => true]
];
?>
...
<?php if(isset($_POST['add'])){
		 ...
		 $time = time();
$sql = "INSERT INTO `expenses` (`expense_id`, `name`, `price`, `create_time`) VALUES (NULL, '$fullname', ' $exchange', '$time');";
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST">
						     ...
						     <div class="mb-3">
                            <label class="form-label" for="venue_name">expense name</label>
