    ...
    <div class="data-table-area">
        ...
        <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                    <input autocomplete="off"  name="supplier" type="text"  class="form-control" placeholder="Supplier Name" name="required" required>
                </div>

             
                    <label class="col-md-2 control-label" for=""><strong>Tin Number</strong></label>
                <div class="col-md-4">
                    <input autocomplete="off"  name="tin" type="text"  placeholder="Tin number" class="form-control" name="required" required>
                </div>
            </div>
            </div>
            <br>
       
              <input type="submit" name="addRequest" Value="Add Supplier">
            </form>
                                    ...
                                    $i = 0;
                                		...
                                		while($fetch = $result->fetch()){
                                     	...
                                     	<tr>
                                            ...
                                            <td>
                                               <a  href="#">Delete</a> |  <a  href="#">Updates</a>
                                            </td>
                                     	</tr>
         <?php
	}
