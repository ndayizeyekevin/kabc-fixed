                                    ...
                                    $i = 0;
                                		...
                                		while($fetch = $result->fetch()){
                                		  //  die(var_dump($fetch));
											...
											<div class="col-lg-3">
											<a class="btn btn-info" href="approve.php?id=<?php echo $fetch['req_id']?>">Approve this request</a>
											</div>
											<?php
                                     	}?>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                		$result = $db->prepare("SELECT * FROM voided_items");
                                        $result->execute();
                                		while($fetch = $result->fetch()){
                                		    $i++;
                                     	?>
                                     	<tr>
                                            ...
                                            <td><a  href=""><?php echo getItemName($fetch['item']); ?></a></td>
                                            <td><?php echo $fetch['qty']; ?></td>
                                             <td><?php echo $fetch['order_code']; ?></td>
                                            
                                             <!--<td><a href="">Comfirm and remove</td>-->
