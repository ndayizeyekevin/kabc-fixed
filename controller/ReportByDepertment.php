...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            WHERE DATE(tbl_requests.requested_date) >= '$from' AND DATE(tbl_requests.requested_date) <= '$to' AND tbl_requests.status !=3 $filterDep GROUP BY tbl_requests.department, tbl_items.cat_id, tbl_items.item_id ORDER BY tbl_requests.department, category.cat_name, tbl_items.item_name
                            ";
