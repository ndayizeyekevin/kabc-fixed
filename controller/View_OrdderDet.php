                            ...
                            <table id="data-table-basic" class="table table-striped" style="font-size:11px;">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th> <a href="../reciept/pro-forma.php?ref=<?php echo $_REQUEST['c']?>" target="_blank" class="btn btn-secondary btn-sm" onclick="if(!confirm('Do you really generate invice?'))return false;else return true;"><i class="fa fa-step-invoice"></i>Invoice</a></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
