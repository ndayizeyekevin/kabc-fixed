<?php
// Always use date filter: default to today if not set, and force today's date if no GET parameters
                ...
                <div class="data-table-list">
                    ...
                    <div class="date-filter no-print">
                        <form method="get" action="">
                            <input type="hidden" name="resto" value="baqueting_report">
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="?resto=baqueting_report" class="btn btn-default">Reset</a>
                                </div>
                                 <div class="col-md-3">
                                    
                                    <a href="?resto=baqueting_report_details" class="btn btn-default">Baqueting Report Details</a>
                                </div>
                    ...
                    <div class="print-section">
                        <div class="table-responsive">
                            <h4 style="font-size: 28px;font-weight:bold;">Baqueting Report as on <strong><?php echo $from_date; ?></strong> To <strong><?php echo $to_date; ?></strong></h4>
                            <table id="data-table-basic" class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>PRICE</th>
                                        <th>Amount</th>
                                        <!-- Status column removed: not relevant for total requisitions summary -->
                                    </tr>
                                </thead>
<?php
$i = 0;
// Base SQL with necessary JOINs
 $sql = "SELECT tbl_request_details.*, SUM(tbl_request_details.quantity) as qtys , tbl_items.*, tbl_requests.created_at, tbl_requests.status, tbl_requests.requested_date 
    ...
    WHERE tbl_requests.req_type = 'Baqueting' AND tbl_requests.status = 8";  // Only show stocked out (status=8)

// Always use date filter: default to today if not set, and force today's date if no GET parameters
$sql .= " AND DATE(tbl_requests.requested_date) >= '$from_date' AND DATE(tbl_requests.requested_date) <= '$to_date'";

$sql .= " GROUP BY tbl_requests.requested_date, tbl_request_details.items ORDER BY tbl_requests.requested_date DESC, tbl_request_details.items ASC";
...
<tr>
    ...
    <!-- Status cell removed: not relevant for total requisitions summary -->
</tr>
<?php } ?>
<tr>
    <td colspan="5"><strong>Total</strong></td>
    <!-- <td><?php echo getItemStock($fetch['items']); ?></td> -->
