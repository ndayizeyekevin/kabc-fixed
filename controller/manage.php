...
<!-- Breadcomb area Start-->
    ...
    <div class="data-table-area">
        ...
        <div class="modal-content">
           <a href="index.php?resto=requestStore" class="btn btn-danger">Go Back</a>
        </div>
      ...
      <div class="modal-body">
        <form method="POST" action="">
          ...
          <div class="form-group">
            ...
            <input type="number" name="quantity" type="text" id="number" placeholder="Quantity" class="form-control" pattern="^\d+(\.\d)?$" inputmode="decimal" class="form-control" required>
...
<div class="modal fade" id="rmv" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).ready(function(){
      $(document).on('click','.btn_addOrder', function(){
        ...
        html+='<td><input autocomplete="off" type="text" id="number" class="form-control" pattern="^\d+(\.\d)?$" inputmode="decimal" class="form-control quantity" name="quantity[]" required placeholder="0"></td>';
  ...
  input.addEventListener('input', function () {
    ...
    //   .replace(/^(\d*\.\d?).*/g, '$10'); // allow only one digit after dot
  });
