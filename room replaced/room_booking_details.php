                                    ...
                                    WHERE tbl_cmd_qty.cmd_code='" . $code . "'");
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $menu_price * $fetch['cmd_qty']; ?></td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        try {
                                            ...
                                            ?>
                                                <a href="?resto=room_booking_details&booking_id=<?php echo $invoice_booking_id; ?>&invoice_booking_id=<?php echo $invoice_booking_id; ?>" class="btn btn-outline-warning btn-sm">
                                                    Generate Invoice
                                                </a>
                                        <?php
                                            }
                                        ...
                                        <div class="card mt-2 mb-2" id="invoice">
                                            ...
                                            <div class="card-body p-1">
                                                ...
                                                <div class="guest-info">
                                                    ...
                                                    ?>
                                                        <p class="mb-0 small">
                                                            <strong>Guest:</strong> <?php echo $row['first_name'] . " " . $row['last_name'] ?><br>
                                                ...
                                                <div class="charges mt-1">
                                                    ...
                                                    <table class="table-sm" style="width:100%">
                                                        ...
                                                        <tr class="font-weight-bold">
                                                            ...
                                                            <td class="text-end"><strong><?php echo number_format($total); ?> RWF</strong></td>
                                                        </tr>
                        ...
                        */
                                                ...
                                                if (isset($_GET['invoice_booking_id']) && $_GET['invoice_booking_id'] != '' && !empty($_GET['invoice_booking_id'])) {
                                                    ...
                                                    (null, :booking_id, :inv_date, :inv_guest_id, :room_no, '', :total, :paid, :balance)");
                                                        ...
                                                        if ($result) {
                                                            echo "<script>alert('Invoice created successfully'); window.location='?esto=room_booking_details&booking_id=$booking_id'</script>";
                                                        } else {
                                                            echo "<script>alert('Failed to create invoice'); window.location='?esto=room_booking_details&booking_id=$booking_id'</script>";
                                                        }
                                                    } catch (Exception $e) {
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p><strong>Total accomodation :</strong> <?php
                                                                                                        ...
                                                                                                        echo number_format($row['room_price'] * $night); ?> RWF</p>
                                                            ...
                                                            <p><strong>Total addittion Service fee:</strong> <?php
                                                                                                                ...
                                                                                                                echo number_format($no); ?> RWF</p>


                                                            <p><strong>Total restaurant:</strong> <?php


                                                                                                    echo number_format($menutotal); ?> RWF</p>


                                                            <p><strong>Total To pay:</strong> <?php

                                                                                                // $topay = $accomodation + $menutotal + $no;
                                                                                                echo number_format($total); ?> RWF</p>


                                                            <p><strong>Paid:</strong> <?php


                                                                                        echo number_format($paidAmount); ?> RWF</p>
                                                            ...
                                                            <hr>
                                                            <p><strong>Balance:</strong> <?php
                                                                                            $balance = $total - $paidAmount;
                                                                                            echo number_format($balance); ?> RWF</p>
                                                            ...
                                                            <?php if ($balance > 0) {
                                                                ...
                                                                <a class="btn btn-info" href="confirmCheckout.php?balance=<?php echo $balance ?>&&booking_id=<?php echo $_REQUEST['booking_id'] ?>&&room=<?php echo getRoomName(getBookedRoom($row['id'])) ?>&&booking_amount=<?php echo $accomodation ?>"> Confirm checkout</a>
                                                        ...
                                                        ?>
                                                            ...
                                                            <a class="btn btn-info" href="#" data-bs-toggle="modal" data-bs-target="#corporateModal">
  Add Corporate
</a>
                                                        <?php
                                                                } ?>
    ...
    <div class="modal-content">
      <form action="confirmCheckout.php" method="GET">
        ...
        <div class="modal-body">
          ...
          <input type="number" class="form-control" name="tin_number" placeholder="TIN Number" required>
          ...
          <input type="hidden" name="booking_amount" value="<?php echo $accomodation ?>">
        </div>
        <div class="modal-footer">
