...
if(isset($_POST['add_item'])){
    ...
    $stmt = $db->prepare("SELECT * FROM tbl_request_details WHERE items = '".$item."' AND req_code = '".$code."'");
    $stmt->execute();
    $count = $stmt->rowCount();
    if($count > 0){
     $msge="Item Is Already On This Requisition List!";
    echo '<meta http-equiv="refresh"'.'content="2;URL=?resto=request&req='.$code.'">';
    }
    else{
    $sql = $db->prepare("INSERT INTO `tbl_request_details`(`req_code`, `items`, `quantity`)
    ...
    if($sql->execute()){
      ...
      $error = $sql->errorInfo();
      $msge="Database Error: " . $error[2];
      echo '<meta http-equiv="refresh"'.'content="3;URL=?resto=request&req='.$code.'">';
    }
    }
}
?>
        ...
        <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                 <input type="text" name="req_type" value="Bar" class="form-control" required readonly>
                </div>
                    </div>
            <div class="form-group">
                <div class="col-md-12">
            ...
            <div class="form-group">
    		    <div class="form-actions col-md-12">
    		        <br />
    		        <center>								
    			        <button type="submit" name="add" id="" class="btn btn-sm label-info margin" style="border-radius: 4px;" onclick="if(!confirm('Do you really want to add this request?'))return false;else return true;"><i class="fa fa-fw fa-save"></i> Save</button>
        ...
        <div class="modal fade" id="adds" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="?resto=request&req=<?php echo $_GET['req']; ?>">
                  <div class="form-group">
