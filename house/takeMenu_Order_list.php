            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="normal-table-list mg-t-30">
                      ...
                      <hr>
                        <a href="https://nstcr.gope.rw/reciept/bon.php?ref=<?php echo $_REQUEST['s']?>" class="btn btn-secondary btn-sm" onclick="if(!confirm('Print bon?'))return false;else return true;"><i class="fa fa-step-invoice"></i>Kitechen</a>
                    </div>
                </div>
            </div>
        </div>
