                          ...
                          <div class="row">
                            <?php
                                ...
                                $code = $fetch['cmd_code'];
                             	...
                             	?>
                            <a href="?resto=prcsOrder_prcssng_view&m=<?php echo $reservation_id ?>&c=<?php echo $code ?>" onclick="if(!confirm('Do you really want to View?'))return false;else return true;">
