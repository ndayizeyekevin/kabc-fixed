...
<head>
    ...
    <style>
        ...
        .table th, .table td { padding: 5px 7px; border: 1px solid #141414ff; font-size: 10px; }
        thead { background-color: #f96221ff; font-weight: bold; color: #fff !important; }
        h1, h2, h3, h4 { margin: 3px 0; padding: 0; }
        hr { margin: 6px 0; border: none; border-top: 1px solid #131212ff; }
        .btn { display: none; }
