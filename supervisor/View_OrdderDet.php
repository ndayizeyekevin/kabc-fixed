...
<p>Quantity of item writen bellow will be voided</p>
...
?>
<br></br>
<input type="submit" name="ConfimVoid" value="Confirm Void">
</form>
...
<div style=" width:300px">
<center><form method="POST">
<p>Quantity of item writen bellow will be moved to separate invoice</p>
 <?php $menu_id = $_POST['menu_id'];
...
?>
    ...
    <br></br>
  <input type="submit" name="saveseparate" value="Confirm Separate">
</form>
...
?>
                                ...
                                <tfoot>   
                                    <tr>
                                        ...
                                        <!-- <th> <a href="../reciept/pro-forma.php?ref=<?php echo $_REQUEST['c']?>" class="btn btn-secondary btn-sm" onclick="if(!confirm('Do you really generate invice?'))return false;else return true;"><i class="fa fa-step-invoice"></i>Invoice</a> 
                                      </th>
                                         -->
                                        <th>
