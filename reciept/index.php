...
$html = '';
 ...
 $ebmdata = $_SESSION['ebmdata'];
 $tax = $_SESSION['total'] * 18/100;
 $total = $_SESSION['total'];
 $tin = $_SESSION['tin'];

$img = '<img src="https://saintpaul.gope.rw/reciept/rra.png" style="width: 40px;height: 40px;">';
...
<table border="0" align="center" width="100%">
    ...
    <tr>
        <td align="center" style="display: grid;">
            ...
            <span>This is not offical invoice </span>
...
<tr>
    ...
    <td align="right" style="padding-right: 20px;"> '.$total.'.00</td>
</tr>
<tr>
...
<tr>
<td align="center">
<img src="https://saintpaul.gope.rw/reciept/qr.png">
