...
$expenses_payments  =  $expenses_payments + $row['price'];
	...
	?>
              ...
              <div class="colr-area">
        <div class="container">
              <h5 class="card-header">Room  Status <a href="print.php?page=roomstatus" class="btn btn-info">Print</a ></h5>
...
<?php 
$no = 0;
$sql = $db->prepare("SELECT * FROM tbl_acc_booking where booking_status_id = 6 OR  booking_status_id = 2");
                        		$sql->execute();
                        		while($row = $sql->fetch()){
