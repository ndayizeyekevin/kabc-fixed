	...
	?>
        ...
        <div class="container">
                ...
                <form method="POST">
                    ...
                    <input type="date" class="form-control" name="searchdate" required>
                    <br>
                    <button type="submit" name="searchdatebtn" class="btn btn-info"> search</button>
                    
                    
                </form>
              <h5 class="card-header">RENTAL REPORT <a href="print.php?page=rent" class="btn btn-info">Print</a ></h5>
