...
if (empty($_POST['clientTin']) || trim($_POST['clientTin']) === 'null') {
  ...
  $receipt = '{"custTin":'.$tin.',"custMblNo":"'.$clientPhone.'","rptNo":'.$lastSale.',"trdeNm":"","adrs":"'.$company_address.'","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: $branch_tin","btmMsg":"Welcome","prchrAcptcYn":"N"}';        
    ...
    case $salestype == 'N' && $rectype == 'S' :
      ...
      case $salestype == 'C' || $rectype=='R':
        ...
        $purchase_code = $rows['custTin'] =="null" ? "null" : $purchase_code;
         ...
         $receipt = '{"custTin":'.$tin.',"custMblNo":'.$phone.',"rptNo":1,"trdeNm":"KABC","adrs":"'.$company_address.'","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: $branch_tin","btmMsg":"Welcome","prchrAcptcYn":"N"}';        
...
// print_r($jsonIO);
 sendStockIO($jsonIO);
  ...
  $receipt_info = addslashes('{"custTin":"'.$tin.'","custMblNo":null,"rptNo":1,"trdeNm":"KABC","adrs":"'.$company_address.'","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: $branch_tin","btmMsg":"Welcome","prchrAcptcYn":"N"}');
