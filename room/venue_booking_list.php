...
<body>
    <style>
      /* Tighten spacing between date filters and table */
      .container.py-4 { padding-top: 0.25rem !important; padding-bottom: 0.25rem !important; }
      .card > .container.py-4 { margin-bottom: 0 !important; padding-bottom: 0 !important; }
      #fillterForm { margin-bottom: 0 !important; }
      #reservationsTable { margin-top: 0 !important; }
      /* Reduce padding on the card body that holds the table */
      .card.mb-4 > .card-body { padding-top: 0.25rem !important; }
      /* Remove any margin on the DataTables wrapper created for the table */
      #reservationsTable_wrapper { margin-top: 0 !important; }
      /* Ensure no gap between filter container and card body */
      .card.mb-4 > .container.py-4 + .card-body { margin-top: 0 !important; padding-top: 0.25rem !important; }
      .card.mb-4 .card-header { margin-bottom: 0 !important; }
      /* Collapse Bootstrap/DataTables row spacing */
      .dataTables_wrapper .row { gap: 0 !important; }
      /* Reduce DataTables default spacing */
      .dataTables_wrapper > .row { margin-top: 0 !important; margin-bottom: 0.25rem !important; }
      .dataTables_wrapper .dataTables_length { margin-top: 0 !important; padding-top: 0 !important; }
      .dataTables_wrapper .dataTables_filter { margin-top: 0 !important; padding-top: 0 !important; }
      .dataTables_wrapper .dataTables_info { margin-top: 0 !important; padding-top: 0 !important; }
      .dataTables_wrapper .dataTables_paginate { margin-top: 0 !important; padding-top: 0 !important; }
      table.dataTable { margin-top: 0 !important; margin-bottom: 0.5rem !important; }

      /* Prevent filter form inputs from collapsing to tiny widths */
      #fillterForm { width: 100% !important; }
      #fillterForm .d-flex.flex-column { min-width: 220px; }
      #fillterForm input[type="date"] { min-width: 200px; }
      #fillterForm label { margin-bottom: 0.25rem; }
    </style>
<div class="colr-area">
        <div class="container">
            <!-- Side Menu -->
                            ...
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="?resto=venue_inventory" type="button" id="addReservationModalBtn" class="btn btn-outline-primary">
                                         View inventory
                                        </a>
                                    ...
                                    <div class="card-body py-2">
                                        <form id="fillterForm" method="get" class="d-flex flex-wrap gap-3 align-items-end">
                                            ...
                                            <!-- Submit Button -->
                                            <div>
                                            <button type="submit" class="btn btn-primary" id="filiterBtn">filiter</button>
                                            </div>
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        const rows = data.map(element => {
            const { id, venue_name, customer_name, reservation_date, reservation_end_date, start_time, end_time, amount, status } = element;
            return `
    <tr>
        <td>${id}</td>
        <td>${venue_name}</td>
