...
$qrcode = '<img src="https://saintpaul.gope.rw/reception/phpqrcode/'.$PNG_WEB_DIR.basename($filename).'" width="100" height="100"/>';  
...
if($data->dcRt != 0){
  ...
  $price=$price.number_format($data->prc,2)."<br><br>";
...
$html .= 'body {
        ...
        .invoice-table {
            ...
            height: 500px; /* Set the table height */
        }
        .right {
            text-align: right;
        }';
$html .= '</style>';
$html .= '</head><body>';
$img = '<img src="https://saintpaul.gope.rw/reception/receipt/images/rra1.png" style="width: 40px;height: 40px;  ">';
$img1 = '<img src="https://saintpaul.gope.rw/reception/receipt/images/rra2.png" style="width: 40px;height: 40px; float: right;">';
...
<table align="center" width="100%">
    <tr>
        <td widt="30%">
         ...
         <td align="left">
           ...
           <span><b>'.$title.'</b></span>
           <br>
           <b style="font-size: 15px">REFUND</b><br>
        </td>
    ...
    <tr>  <td style="padding-left: 10px; border: 1px solid black;">
    REF. NORMAL RECEIPT#: '.$ref.'
    <br><span><b>REFUND IS APPROVED ONLY FOR <br>
    ORIGINAL SALES RECEIPT</b></span>
    
    </td> </tr>
    <tr><td><b>INVOICE TO</b></td></td>
    <tr style="">
