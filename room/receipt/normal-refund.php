...
$clientPhone = isset($_REQUEST['clMob']) ? 'CLIENT MOBIL: '.$_REQUEST['clMob'] : '';
...
$qrcode = '<img src="https://saintpaul.gope.rw/reception/phpqrcode/'.$PNG_WEB_DIR.basename($filename).'" />';  
...
<table border="0" align="center" width="100%">
    ...
    <tr>
        <td align="center" style="display: grid;">
            <span> REFUND IS APPROVED ONLY FOR 
            <br>ORIGINAL SALES RECEIPT</span><br>
            <span>'.$tin.'</span><br>
            <span>'.$names.'</span><br>
