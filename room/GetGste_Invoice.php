...
");
	...
	if (isset($_POST['savesales'])) {
		...
		$receipt = '{"custTin": ' . $tin . ',"custMblNo":"' . $phone . '","rptNo":2,"trdeNm":"","adrs":"'.$company_address.'","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: ' . $branch_tin . '\nPhone: ' . $branch_phone . '","btmMsg":"CIS Version 1 Powered by RRA VSDC EBM2.1 \n -------------------------------- \n Welcome","prchrAcptcYn":"N"}';
      ...
      die(var_dump($e));
			...
			"orgSarNo":"' . $invoice . '",
			  ...
			  "itemList":' . $prdct . '
				...
				$receipt_info = addslashes('{"custTin":' . $tin . ',"custMblNo":null,"rptNo":1,"trdeNm":"CSP","adrs":"KN 4 Ave","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: ' . $branch_tin . '\nPhone: ' . $branch_phone . '","btmMsg":"CIS Version 1 Powered by RRA VSDC EBM2.1 \n -------------------------------- \n Welcome","prchrAcptcYn":"N"}');
				...
				$receipt_info = addslashes('{"custTin":"$tin","custMblNo":"0789300811","rptNo":1,"trdeNm":"CSP","adrs":'.$company_address.'","topMsg":"'.$company_name.'\n'.$company_address.'\nTin: ' . $branch_tin . '\nPhone: ' . $branch_phone . '","btmMsg":"CIS Version 1 Powered by RRA VSDC EBM2.1 \n -------------------------------- \n Welcome","prchrAcptcYn":"N"}');
