        ...
        <div class="col-md-6 col-lg-5">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body text-center py-4">
                    ...
                    <p class="text-muted mb-0">Refund overpayment for venue booking #<?php echo htmlspecialchars($booking_id); ?></p>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form method="POST" action="process_venue_refund.php" id="refundForm">
                        <!-- Refund Amount -->
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input 
                                    type="number" 
                                    class="form-control fw-bold fs-3 border-start-0 ps-3" 
                                    name="refund_amount" 
                                    id="refund_amount" 
                                    value="0" 
                            ...
                            <div class="form-text text-success mt-2">
                                ...
                                Maximum refundable amount is <strong><?php echo htmlspecialchars($balance); ?> RWF</strong>
                            </div>
                        </div>
