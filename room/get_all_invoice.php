...
// Query to fetch invoices within date range
$sql = "SELECT `inv_id`, `booking_id`, `inv_date`, `inv_guest_id`, `room_no`, `description`, `Total`, `Paid`, `balance` 
        FROM `invoice` 
        WHERE `inv_date` BETWEEN '$start_datetime' AND '$end_datetime'
    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4">
            <div class="card-header bg-info text-white">
                <h6 class="mb-0">Filter Invoices by Date Range</h6>
            </div>
            <div class="card-body">
                <form method="get" class="row g-3">
                    <input type="hidden" name="resto" value="all_invoices">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4 d-flex align-items-end">
                        ...
                        <a href="?resto=all_invoices" class="btn btn-secondary">Reset to Today</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Invoices (<?php echo $start_date == $end_date ? date('M d, Y', strtotime($start_date)) : date('M d, Y', strtotime($start_date)) . ' - ' . date('M d, Y', strtotime($end_date)); ?>)</h5>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                echo "<tr><td colspan='9' class='text-center'>No invoices found for the selected date range</td></tr>";
                            }
                            ?>
                            <tr>
