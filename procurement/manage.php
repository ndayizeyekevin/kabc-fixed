...
<!-- Breadcomb area Start-->
    ...
    <div class="data-table-area">
        ...
        <div class="modal-content">
           <a href="https://nstcr.gope.rw/procurement/index">Go Back</a>
 ...
 <?php }
	...
	?>			
                ...
                <div class="col-md-5">
                    ...
                    <input autocomplete="off"  name="qty" type="number"  Placeholder="Quantity" class="form-control" name="required" required>
                </div>
                      <div class="col-md-2">
           <br>
