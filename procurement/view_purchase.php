...
if ($conn->query($sql) === TRUE) {
 echo "<script>window.location='index?resto=purchases'</script>";
} else {
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="form-group">
                <label class="col-md-2 control-label" for=""><strong>Select Supplier</strong><span class="text-danger">*</span></label>
...
?><option value='<?php echo $fetch['id']?>'><?php echo $fetch['name']?></option>
 <?php }
	...
	?>
                    ...
                    <label class="col-md-2 control-label" for=""><strong>VAT</strong></label>
                <div class="col-md-4">
                                        			<select required name="vat" class="form-control">
                                     	...
                                     	<tr>
                                            ...
                                            <td><?php echo number_format($fetch['qty'] * getItemPrice($fetch['item_id'])); ?> </td>
                                             ...
                                             <td>
                                              ...
                                              echo number_format($fetch['pur_price']);
                                             } ?>
                                             ...
                                             if($fetch['pur_price']==null){
                                              ...
                                              echo number_format($fetch['pur_qty'] * $fetch['pur_price'],2);
                                             } ?>
