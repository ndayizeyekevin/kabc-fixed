...
<center><H3>LOCAL PURCHASE ORDER  </H3></center>
      ...
      <td>
       ...
       <td>
        ...
        <h5> LPO Number:     <?php echo $_REQUEST['id']?>      </h5>
       ...
       <td>
        ...
        <h5> DATE:     <?php $result = $db->prepare("SELECT * FROM  store_request WHERE req_id='".$_REQUEST['id']."'");
                                        $result->execute();
                                		while($fetch = $result->fetch()){
            ...
            <table border="0" style="width:100%">
                        ...
                        $amount = $amount + $total;
                                     	...
                                     	<tr>
                                            ...
                                            <td style="border: 1px solid black;"><?php echo getItemName($fetch['item_id']); ?></td>
                                            <td style="border: 1px solid black;"><?php echo number_format($fetch['qty']); ?></td>
                                            <td style="border: 1px solid black;"><?php echo number_format(getItemPrice($fetch['item_id'])); ?></td>
                                             <td style="border: 1px solid black;"><?php echo number_format(getItemPrice($fetch['item_id']) * $fetch['qty']); ?></td>
...
?>
	...
	<td><H6><?php echo number_format($amount)?> </H6></td>
    ...
    <b>Procurement And Purchase office</b> <br>Ordered by: <?php echo $_SESSION['f_name']." ". $_SESSION['l_name']?> <br><br> Signature .........................
    
      </td>
              <td>
 
    <b>Logistics</b> <br>Verified by: ....................... <br><br> Signature .........................
      ...
      <b><?php    $by= $_SESSION['f_name']." ". $_SESSION['l_name']; if($request==$by){
