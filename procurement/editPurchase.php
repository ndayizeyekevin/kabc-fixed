...
$sql = "UPDATE request_store_item SET pur_qty='$qty',pur_price='$price' WHERE id='".$_REQUEST['id']."'";
if ($conn->query($sql) === TRUE) {
    $id= $_REQUEST['delivery'];


      echo "<script>alert('Purchased Added')</script>";
          ...
          <div class="row">
            <div class="form-group">
              <h4>  <?php echo getItemName($item);?> </h4>
                ...
                <div class="col-md-4">
            <input type="text" name="qty" placeholder="enter Quantity" value="<?php echo $rqty ?>" class="form-control">

                </div>
                    <label class="col-md-2 control-label" for=""><strong>Unit Price</strong></label>
                <div class="col-md-4">

                             <input type="text" name="price" placeholder="enter Unit Price" value='<?php echo getItemPrice($item) ?>' class="form-control">
