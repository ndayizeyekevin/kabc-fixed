...
$sql = "INSERT INTO `currencies` (`currency_id`, `name`, `currency_exchange`) VALUES (NULL, '$fullname', '$exchange');";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
	...
	<tr>
                                                    ...
                                                    <td><?php echo $row['currency_exchange'];?></td>
                                                    
                                                
                                                  
                                                    <th><a href="updateCurrency.php?id=<?php echo $row['currency_id']?>">Update</a></th>
                                                </tr>
