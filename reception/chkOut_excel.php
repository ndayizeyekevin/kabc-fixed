            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="tab-hd">
                            <h2><small><strong><i class="fa fa-refresh"></i> Checkout Report</strong></small></h2>
                        </div>
                     <hr>
                    <br>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#date_to").change(function () {
            ...
            $.get('load_chkout.php?ten=' + $(this).val() + '&date_from=' + date_from + '&date_to=' + date_to , function (data) {
