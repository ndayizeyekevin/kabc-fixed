...
curl_close($curl);
        ...
        if (isset($responseData['resultCd'])) {
            ...
            if ($code == '000') {
                ...
                $uuid = 123;
                $receipt_info = addslashes('{"custTin":"'.$tin.'","custMblNo":null,"rptNo":1,"trdeNm":"Nstc","adrs":"KN 4 Ave / 0789303811","topMsg":"CENTRE SAINT PAUL LTD\nKN 4 Ave / 0789303811\nTin: '.$branch_tin.'","btmMsg":"Welcome","prchrAcptcYn":"N"}');
  ...
  rcptNo='$rcptNo'");
                $sql_inf->execute();
		$tin = (int)($tin ?? 0);
                $receipt_info = addslashes('{"custTin":"$tin","custMblNo":"0788389978","rptNo":1,"trdeNm":"CENTRE SAINT PAUL LTD","adrs":"KN 4 Ave / 0789303811","topMsg":"CENTRE SAINT PAUL LTD\nKN 4 Ave / 0789303811\nTin: '.$branch_tin.'","btmMsg":"Welcome","prchrAcptcYn":"N"}');
