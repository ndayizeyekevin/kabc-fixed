...
$tot = $_REQUEST['total'];
$vs = $_REQUEST['vs'];
$tin = $_REQUEST['tin'] =='null' ? '': '<b>CLIENT TIN</b>: '.$_REQUEST['tin'];
$sign = $_REQUEST['sign'];
$int = $_REQUEST['int'];
...
$clientPhone = isset($_REQUEST['clMob']) ? '<b>CLIENT MOBILE</b>: '.$_REQUEST['clMob'] : '';
$names = isset($_REQUEST['names']) ? '<b>CLIENT NAME</b>: '.$_REQUEST['names'] : '';
...
$qrcode = '<img src="http://localhost/resto/reception/phpqrcode/'.$PNG_WEB_DIR.basename($filename).'" />';  
...
$html .= '</style>';
$html .= '</head><body>';
$img = '<img src="http://localhost/ebm/pages/receipt/images/rra1.png" style="height: 100px;  ">';
...
<tr>
    <td><hr style="border: none; border-top: 1px solid black; width: 100%;" /></td>
</tr>
</table>
...
<tr>
    ...
    <td align="right" style="padding-right: 20px;">V'.$cis_version.'</td>
