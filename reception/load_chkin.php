...
<table id="data-table-basic" class="table table-striped">
    <a href="rpt_chk_in.php?&date_from=<?php echo $date_from;?>&date_to=<?php echo $date_to;?>" name="export_excel1" class="btn btn-success pull-right" title="click to download" style="margin:5px;"><i class="fa fa-file-text"></i> Export Excel</a>
    <thead>
        <tr>
            <th>Names</th>
            <th>Nationality</th>
    	...
    	<tbody>
            <?php
                ...
                WHERE status = 11 AND arrival BETWEEN '".$date_from."' AND '".$date_to."' 
