                        ...
                        <div class="table-responsive">
                            ...
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                		$result = $db->prepare("SELECT * FROM  store_request where status=1");
                                        $result->execute();
                                		while($fetch = $result->fetch()){
                                     	...
                                     	<tr>
                                     	    <td><?php echo $i; ?></td>
                                            <td><a  href="#"><?php echo $fetch['req_code']; ?> - <?php echo $fetch['request_from']; ?></a></td>
										...
										<?php if($fetch['status']==1){?>
                                              <a  href="?resto=view_purchase&&id=<?php echo $fetch['req_id']?>">View</a> | 
                                               <a  href="?resto=printPurchase&&id=<?php echo $fetch['req_id']?>&&sup=<?php echo $fetch['supplier']?>" class="btn btn-info">Print</a>
										<?php } ?>
											</td>
                                     	</tr>
         <?php
