...
$sql = "INSERT INTO `request_store_item` (`id`, `item_id`, `qty`, `req_id`, `del_qty`, `del_price`) VALUES (NULL, '$item', '$qty', '".$_REQUEST['req']."', '$qty', '$price');";
if ($conn->query($sql) === TRUE) {
...
//   href="?resto=view_purchase&&id=74&&supplier=36"
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="form-group">
                ...
                <div class="col-md-4">
                <input type="number" step='0.001' name="qty" placeholder="enter Quantity" class="form-control">	
	
                </div>
                    <label class="col-md-2 control-label" for=""><strong>Unit price</strong></label>
                <div class="col-md-4">
                             <input type="number" step='0.001' name="price" placeholder="enter Unit Price" class="form-control">	
