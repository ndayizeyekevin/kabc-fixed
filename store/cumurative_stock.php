        ...
        <div class="card-body p-4">
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center">
                    ...
                    <tbody>
                        <?php
                        $sql = mysqli_query($conn, "SELECT * FROM tbl_progress, tbl_items WHERE tbl_items.item_id = '" . $_GET['item_id'] . "' AND tbl_progress.item = '" . $_GET['item_id'] . "' ORDER BY tbl_progress.created_at DESC, tbl_progress.prog_id");
                        $total_in = 0;
                        $Out_qty = 0;
