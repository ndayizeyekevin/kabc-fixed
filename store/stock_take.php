...
// 		    $total = $price1  + $q;
		 ...
		 $sql = "INSERT INTO `tbl_progress` (`prog_id`, `date`, `in_qty`, `last_qty`, `out_qty`, `item`, `end_qty`, `new_price`) VALUES (NULL, '$date','0', '$qty', 'NULL','$item', '$qty', '$price');";
...
$sql = "UPDATE  tbl_item_stock SET qty='$qty' WHERE item='$item'";
...
$sql = "INSERT INTO `stock_take` (`id`, `item`, `qty`,status, `created_at`) VALUES (NULL, '$item', '$price', '$status','$date');";
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="table-responsive">
                            ...
                            <?php
     $stmt = $db->query("SELECT * FROM tbl_item_stock  INNER JOIN tbl_items ON tbl_items.item_id =tbl_item_stock.item WHERE tbl_item_stock.item='".$_REQUEST['myId']."'");
     $tbl_progress = $db ->query ("SELECT * FROM tbl_progress WHERE item = '".$_REQUEST['myId']."' ORDER BY prog_id DESC LIMIT 1;");
                    try {
        ...
        <div class="modal-content">
            ...
            <label class="col-md-2 control-label" for=""><strong>Item Quatinty</strong><span class="text-danger">*</span></label>
                 <div class="col-md-4">
                    <input type="text" name="qty" value="<?php echo $qty?>" placeholder="Quantinty" class="form-control" required>
                        <input type="hidden" name="qty1" value="<?php echo $qty?>" placeholder="Quantinty" class="form-control" required>
                </div>
                <label class="col-md-2 control-label" for=""><strong>Item Price</strong><span class="text-danger">*</span></label>
                 <div class="col-md-4">
                     ...
                     while($row2 = $tbl_progress->fetch(PDO::FETCH_ASSOC )){
                //   echo "new Price". $row2['new_price'];
              ...
              ?>
                <input type="text" name="price" value="<?php echo ($new_price > 0) ? $new_price : $price?>" placeholder="Price" class="form-control" required>
