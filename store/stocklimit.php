...
$sql = "UPDATE tbl_item_stock SET limit_data='$price' WHERE item='$qty'";
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="form-group">
                <label class="col-md-2 control-label" for=""><strong>Select Item</strong><span class="text-danger">*</span></label>
...
?><option value='<?php echo $fetch['item']?>'><?php echo getItemName($fetch['item'])?></option>
 <?php }
	...
	?>			
                    ...
                    <label class="col-md-2 control-label" for=""><strong>Limit</strong></label>
                <div class="col-md-4">
                             <input type="number" name="price" placeholder="enter Limit" min="1" class="form-control">	
