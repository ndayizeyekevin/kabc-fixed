                ...
                <div class="data-table-list">
                        ...
                        <form method="get" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="?resto=baqueting_report_details" class="btn btn-default">Reset</a>
                                </div>
                               <div class="col-md-3">
                                    
                                    <a href="?resto=baqueting_report" class="btn btn-default">Baqueting Report</a>
                                </div>
                    ...
                    <div class="print-section">
                        <div class="table-responsive">
                            <h4 style="font-size: 28px;font-weight:bold;">Baqueting Report as on <?php echo "<strong>". $_GET['from_date'] ."</strong>" ?> To <?php echo "<strong>". $_GET['to_date'] ."</strong>" ?></div>
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $today = date('Y-m-d');
    $sql .= " AND DATE(tbl_requests.requested_date) = '$today'";
}
