                ...
                <div class="data-table-list">
                        ...
                        <form method="get" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="?resto=staff_report_details" class="btn btn-default">Reset</a>
                                    <a href="?resto=staff_report" class="btn btn-default">Staff Report</a>
                                </div>
                    ...
                    <div class="print-section">
                        <div class="table-responsive">
                            <h4 style="font-size: 28px;font-weight:bold;">Staff Meal Report as on <?php echo "<strong>". $_GET['from_date'] ."</strong>" ?> To <?php echo "<strong>". $_GET['to_date'] ."</strong>" ?></div>
...
// Base SQL with necessary JOINs
 $sql = "SELECT tbl_request_details.*, SUM(tbl_request_details.quantity) as qtys , tbl_items.*, tbl_requests.created_at, tbl_requests.status, tbl_requests.requested_date 
    ...
    WHERE tbl_requests.req_type = 'Staff' AND tbl_requests.status = 8";  // Only show stocked out (status=8)
