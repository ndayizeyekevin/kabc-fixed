...
$cnpy = $_SESSION['cid'];
$room = $_SESSION['id'];
$date_in = $_SESSION['chk_in_date'];
$date_out = $_SESSION['chk_out_date'];
$bed_type = $_SESSION['bed'];

$today = date("Y-m-d H:i:s");

 if (isset($_REQUEST['usn']) and isset($_REQUEST['pwd']))
    {
        echo $_SESSION['chk_in_date'];
       ...
       if($room != ''){
        ...
        if ($sql->rowCount() != 0) {
            ...
            VALUES ('$user_ID','$room','$bed_type','$date_in','$date_out','$cnpy','$today',3)";
            $db->exec($sql1);
