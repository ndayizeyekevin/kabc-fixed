...
$breadcrumb_items = [
    ['name' => 'Services', 'link' => '../services/services.php', 'active' => false],
    ['name' => 'Services & Items', 'link' => '', 'active' => true]
];
?>
...
$sql = "INSERT INTO `services` (`service_id`, `service_name`, `service_price`) VALUES (NULL, '$fullname', '$exchange');";
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST">
						     ...
						     <div class="mb-3">
                            <label class="form-label" for="venue_name">Service name</label>
