                                            ...
                                            if($cat==2){
                                               ...
                                               if($printed==null){
                                                $printedIdbar = $printedIdbar.$itemslistss.",";
                                                  $bonbar = $bonbar.getname($mid).'<br> Qty: '.$fetrooms['cmd_qty'].' x'.getprice($mid).'<br> '.$fetrooms['message'].'<hr style="border: none; border-top: 1px dashed black; width: 100%;" />';
                                               ...
                                               if($printed==null){
                                                ...
                                                $bon = $bon.getname($mid).'<br> Qty: '.$fetrooms['cmd_qty'].' x'.getprice($mid).'<br>'.$fetrooms['message'].'<hr style="border: none; border-top: 1px dashed black; width: 100%;" />';
                                            }}
                                               ...
                                               if($cat==32){
                                                ...
                                                $coffe = $coffe.getname($mid).'<br> Qty: '.$fetrooms['cmd_qty'].' x'.getprice($mid).'<br>'.$fetrooms['message'].'<hr style="border: none; border-top: 1px dashed black; width: 100%;" />';
